...
export const AuthStorage = {
  ...
  setTokens(accessToken: string, refreshToken: string, rememberMe: boolean): void {
    ...
    // 同时存储到 application-cloud-user 以兼容后端接口
    localStorage.setItem("application-cloud-user", JSON.stringify({ token: accessToken }));
  },
  ...
  clearAuth(): void {
    ...
    // 清除 application-cloud-user
    localStorage.removeItem("application-cloud-user");
  },
